...
public class Login extends Application {
    ...
    private static volatile com.example.user.ncpaidemo.Login instance = null;
        ...
        public IApplicationConfig getApplicationConfig() {
            return new IApplicationConfig() {
                ...
                public Context getApplicationContext() {
                    return com.example.user.ncpaidemo.Login.getGlobalApplicationContext();
                }
            };
        }
    }

    public static com.example.user.ncpaidemo.Login getGlobalApplicationContext() {
        if(instance == null) {
